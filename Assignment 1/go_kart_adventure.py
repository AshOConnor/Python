...
# This section asks the user to input a name for the variable
...
# This section also asks you a question that must be answered correctly to proceed in the story.
# The variable "adventuring" could of been called "adventure" but is best
...
# The variable name "adventuring" could alternatively be "adventure" but is best suited for this code.
...
if adventuring == "Yes":
    ...
    sys.stdout.write("I told you to answer Yes or No " + name + ". Bad luck, you're coming anyway!\n")
...
# The variable name "number" could alternatively be "num" but is best suited for this code.
if number != 1:
    sys.stdout.write("\n")
...
if torch == "Off":
    ...
    sys.stdout.write(
        "To your horror you find " + snake + " hissing at the light. You yell at " + snake + " to getaway.\n")
...
# Using different lines to write the code helps with readability and looks better
...
sys.stdout.write("\n")
sys.stdout.write(
    "You continue driving down the tunnel in your Go Kart and finally can start to see the light at the end of the "
    "tunnel.\n")
sys.stdout.write(
...
if path == "Shortcut":
    ...
    sys.stdout.write("The Go Kart starts losing traction as you come up to a large jump. You hit the jump and do a "
                     "360 in the air.\n")
    sys.stdout.write("You stick the landing and start slowing down as you get closer and closer to the bottom.\n")
    sys.stdout.write("As you get to the bottom you can see the road coming up and you turn just in time to safely "
                     "rejoin the road.\n")
    ...
    sys.stdout.write("Just as you reach the bottom your Go Kart decides to turn back on and you can see the exit of "
                     "the shortcut that you didn't take.\n")
...
# THe variable name "answer" could alternatively be "decimal".
...
sys.stdout.write("As " + crocodile + "fades out in the distance you keep driving and can see that the rainforest is "
                                     "getting less dense as you go.\n")
sys.stdout.write("You soon come out of the dense jungle and the landscape has turned into sandy dunes with the sound "
                 "of waves crashing not too far away.\n")
sys.stdout.write("The sound of the waves gets closer and closer and closer! You see a strange figure in the "
                 "distance.\n")
...
if action == "Speed":
    sys.stdout.write("\n")
    sys.stdout.write("You speed up, almost losing control of your Go Kart, you slide around the road hitting the kerb "
                     "and buckling a wheel.\n")
    sys.stdout.write("You stop your vehicle and look around in the footwell and luckily you find a repair kit that "
    ...
    # You can alternatively use a for loop but this is the best method.
    ...
    while i < len(repair_kit):
        ...
        i = i + 1
    sys.stdout.write("You get out of your car trembling from the fright you received from almost crashing and almost "
                     "injuring yourself.\n")
    sys.stdout.write("You take a few minutes to repair the Go Kart.\n")
    sys.stdout.write(
        "Once you finish the repair you jump back in the GoKart and continue driving closer to the mermaid.\n")
    sys.stdout.write("You arrive at the strange-looking creature.\n")

elif action == "Slow":
    sys.stdout.write("\n")
    sys.stdout.write(
        "You slow down to try and gain some confidence about arriving at the destination where the mermaid is.\n")
